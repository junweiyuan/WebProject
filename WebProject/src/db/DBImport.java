	...
	public static void main(String[] args) {
	  	 try {
			//Step 1: Initialize the driver and connect to a SQL server
	  		...
	  		//Step 3: create tables in order of users, restaurants, user_visit_history
	  		...
	  		sql = "CREATE TABLE RESTAURANTS "
	   		...
	   		BufferedReader reader = new BufferedReader(new FileReader(
	   		  		"/Users/cc526__baggio/Downloads/business_small.json"));//replace with your real physical path. 
	   		//For windows, it is like "C:\\your_user_name\\yelp_dataset-master\\business_small.json"; 
